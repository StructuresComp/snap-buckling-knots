...
setInput::setInput()
{
  ...
  AddOption("r", " Coefficient of penalty", r);
  AddOption("v_constant", " Velocity of two ends", v_constant);
  AddOption("statictime", " Time to keep static", statictime);
  AddOption("filename", " Name of the configuration file", filename);
  AddOption("data_resolution", "Time resolution for saving data", data_resolution);
